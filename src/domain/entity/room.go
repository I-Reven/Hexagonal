...
type Room struct {
	...
	Status   int64      `cql:"status" json:"status"`
	...
	Rating   int64      `cql:"rating" json:"rating"`
}
...
func (e *Room) GetStatus() int64                      { return e.Status }
func (e *Room) SetStatus(status int64) *Room          { e.Status = status; return e }
...
func (e *Room) GetRating() int64                      { return e.Rating }
func (e *Room) SetRating(rating int64) *Room          { e.Rating = rating; return e }
